    ...
    return(
        <div className="w-full">
            <main className="bg-primary-gray grow overflow-y-auto h-[calc(100vh-67.33px)]">
                ...
                <form className="font-roboto px-6 mx-4 border rounded-lg bg-white min-w-[800px] max-lg:px-4">
                    ...
                    <table className="mb-4 text-zinc-600 w-full">
                        <thead>
                            <tr>
                                ...
                                <th className="border border-b-2 border-opacity-20 border-secondary-gray p-4 text-left w-[210px]">Opsi</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td className="p-4 border-secondary-gray border border-b-2 border-opacity-20 flex flex-nowrap justify-start">
