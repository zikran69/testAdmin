...
import bgJson from '../file-bahe/bg-login.json'
...
export default function LoginPage(){
    ...
    useEffect(()=>{
        setBgLogin(datas.image);
    }, [])
    
    if(bgLogin){
        return(
            <div className="flex items-center justify-center h-screen bg-[url('./src/assets/login.jpg')] bg-cover">
                {
